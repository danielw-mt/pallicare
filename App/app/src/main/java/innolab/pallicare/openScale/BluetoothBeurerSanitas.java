 ...
 */
package innolab.pallicare.openScale;
 ...
 * @author: oliexdev
 * Open Scale Project
 * This class provides all the bluetooth driver functionality like connecting to the device.
 * Retrieving data and saving that data.
 * <p>
 * modification: added display of stable weight on activity_device_measurements.xml
 */


public class BluetoothBeurerSanitas extends BluetoothCommunication {
    public enum DeviceType {BEURER_BF700_800_RT_LIBRA, BEURER_BF710, SANITAS_SBF70_70}
    ...
    protected boolean onNextStep(int stepNr) {
        switch (stepNr) {
            ...
            case 6:
                ...
                currentRemoteUser = null;
                Timber.d("TODO: implement Openscale instance for user");
...
//                }
    ...
    private void processUserInfo(byte[] data) {
        ...
        Timber.d("TODO: add openscale user instance");
...
//        }
    ...
    private void processMeasurementData(byte[] data, int offset, boolean firstPart) {
        ...
        //Klaus: Set UserID to 0, because we don't create users. Otherwise the process stops without any error at this point.
        addMeasurement(measurementData, 0);
    ...
    private void processScaleAck(byte[] data) {
        switch (data[2]) {
            case CMD_SCALE_STATUS:
                ...
                Timber.d("TODO Openscale implementation");
