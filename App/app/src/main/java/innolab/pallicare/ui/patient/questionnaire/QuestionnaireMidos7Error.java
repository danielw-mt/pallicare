...
/**
 * This activity will show a error message, if a problem arised when saving the questionnaire data.
 *
 * @author Klaus Schmidt
 */
public class QuestionnaireMidos7Error extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.quest_simple_one_textView)).setText(getString(R.string.quest_error));
    ...
    protected int getLayoutTitleDescriptor() {
        return R.string.quest_error_activity_title;
    }
    ...
    protected int getHelpText() {
        return R.string.help_quest_7_error;
    }
}
